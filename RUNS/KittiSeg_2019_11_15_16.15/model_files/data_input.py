...
def maybe_download_and_extract(hypes):
    ...
    train_txt = "/home/danny/KittiSeg/data/train3.txt"
    val_txt = "/home/danny/KittiSeg/data/val3.txt"
...
def main():
    """main."""
    with open('/home/danny/KittiSeg/hypes/KittiSeg.json', 'r') as f:
        hypes = json.load(f)

    q = {}
    q['train'] = create_queues(hypes, 'train')
    q['val'] = create_queues(hypes, 'val')
    data_dir = "/home/danny/KittiSeg/DATA"
